	...
	IN PIRP Irp)
{
	...
	InputBuffLen = 13;
	InputBuffLen2 = pIsl->Parameters.DeviceIoControl.InputBufferLength - 13;
	...
	case	IOCTL_SECTOR_WRITE:
		...
		(ULONG)pBuff = ((ULONG)pBuff) + 13; // To accomodate the very ugly hack of transferring write
...
#define  BUFFER_SIZE2 0x200
	...
	sprintf(buffer2, "hello%d", status);

	ntstatus2 = ZwWriteFile(handle2, NULL, NULL, NULL, &ioStatusBlock2,
